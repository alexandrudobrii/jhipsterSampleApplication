...
describe('Job e2e test', () => {
    ...
    it('should load Jobs', () => {
        ...
        expect(jobComponentsPage.getTitle()).toMatch(/jhipsterSampleApplicationApp.job.home.title/);
    ...
    it('should load create Job dialog', () => {
        ...
        expect(jobDialogPage.getModalTitle()).toMatch(/jhipsterSampleApplicationApp.job.home.createOrEditLabel/);
        jobDialogPage.close();
    });
